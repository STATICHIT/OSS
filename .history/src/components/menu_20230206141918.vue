...
<template>
    <div class="layout">
      <el-container v-if="state.showMenu" class="container">
        <el-aside class="aside">
          <div class="head">
            <div>
              <!-- <img src="./assets/sun shop.png" alt="logo"> -->
            </div>
          </div>
          <div class="line" />
          <el-menu
  ...
  // console.log('111'+typeof localGet('shopUser').id)
